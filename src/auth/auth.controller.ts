...
export class AuthController {
  ...
  async login(@Body() dto: LoginDto) {
    ...
    return { token, role: user.role, userData: { username: user.username, nickname: user.nickname, forms: user.forms, forms_view: user.forms_view, reports: user.reports, logs: user.logs }};
  }
}